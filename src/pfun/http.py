...
class HTTP(Immutable, init=False):
    ...
    def __init__(
        ...
        trace_configs: Optional[Iterable[aiohttp.TraceConfig]] = None
    ):
        """
    ...
    def make_request(
        ...
        data: Optional[Union[aiohttp.FormData, bytes, dict]] = None,
        ...
        ssl: Optional[Union[bool, aiohttp.Fingerprint, ssl.SSLContext]] = None,
        verify_ssl: Optional[bool] = None,
        fingerprint: Optional[bytes] = None,
        ssl_context: Optional[ssl.SSLContext] = None,
        proxy_headers: Optional[Mapping] = None
